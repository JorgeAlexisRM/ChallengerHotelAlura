		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					fechaE = txtFechaEntrada.getDate();
					fechaS = txtFechaSalida.getDate();
					
					//Calculo de dias
					dias = 100 * (((int)(fechaS.getTime()-fechaE.getTime())/milisecondsByDay)+1);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					//Calculo de dias
					dias = 100 * ((int)(fechaS.getTime()-fechaE.getTime()));
					txtValor.setText(String.valueOf(dias));*/
					
					System.out.println(String.valueOf(sdf.format(fechaE)));
					reserva = new Reserva(0,String.valueOf(sdf.format(fechaE)),String.valueOf(sdf.format(fechaS)),txtValor.getText());
					reservaC.registrar(reserva);
					idReserva = reservaC.id;
