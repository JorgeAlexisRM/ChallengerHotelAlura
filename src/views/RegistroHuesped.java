		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (txtFechaN.getDate() != null) {
					...
					huespedC = new HuespedController();
					fechaN = txtFechaN.getDate();
					
					System.out.println(String.valueOf(txtNacionalidad.getSelectedItem()));
					huesped = new Huespedes(0, txtNombre.getText(), txtApellido.getText(),String.valueOf(sdf.format(fechaN)),
							String.valueOf(txtNacionalidad.getSelectedItem()), Long.parseLong(txtTelefono.getText()));
					huesped.setIdReserva(id);
					huespedC.registrar(huesped);
